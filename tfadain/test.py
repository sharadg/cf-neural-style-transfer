...
def style_transfer(
        ...
        save_ext='jpg',
        gpu=0,
        vgg_weights='tfadain/models/vgg19_weights_normalized.h5',
        decoder_weights='tfadain/models/decoder_weights.h5'):
    ...
    with tf.Session() as sess:
        ...
        for content_path, style_path in product(content_batch, style_batch):
            ...
            filename = '_stylized_%s.%s' % (style_name, save_ext)
            ...
            generated_image_bytes.name = filename
            save_image(generated_image_bytes, output[0], data_format=data_format)
